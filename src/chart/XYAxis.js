...
(function (root, factory) {
    ...
    XYAxis.prototype.formattedData = function () {
        return this.data().map(function (row) {
            return row.map(function (cell, idx) { return idx === 0 ? this.formatData(cell) : cell instanceof Array ? cell.map(function(d) { return this.formatValue(d);}, this) : this.formatValue(cell); }, this);
        }, this);
    };
    ...
    XYAxis.prototype.update = function (domNode, element) {
        ...
        if (this._prevYAxisType !== this.yAxisType()) {
            ...
            switch (this.yAxisType()) {
                case "pow":
                    ...
                    ;
                    this.valueAxis.tickFormat(d3.format(".2s"));
                    break;
                case "log":
                ...
                case "time":
                    ...
                    this.valueAxis.tickFormat(null);
                    break;
                case "linear":
                    /* falls through */
                default:
        ...
        var min = this.yAxisDomainLow() ? this.formatData(this.yAxisDomainLow()) : d3.min(this.formattedData(), function (data) {
        ...
        var max = this.yAxisDomainHigh() ? this.formatData(this.yAxisDomainHigh()) : d3.max(this.formattedData(), function (data) {
